#
#  Be sure to run `pod spec lint BJBAPPFramework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                     BJBAPPFramework description
                   DESC

  spec.homepage     = "https://github.com/LionelMessiJianBo/BJBAPPFramework"
  ...
  spec.author             = { "bianjianbo" => "bianjianbo@autoforce.net" }
  # Or just: spec.author    = "bianjianbo"
  # spec.authors            = { "bianjianbo" => "bianjianbo@autoforce.net" }
  ...
  spec.source       = { :git => "https://github.com/LionelMessiJianBo/BJBAPPFramework.git", :tag => "#{spec.version}" }
